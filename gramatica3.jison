...
DECLARACION
		...
		|TIPO DEC CALL														{$$ = new nodo("DECLARACION", [$1,$2,$3])}
		|TIPO DEC E 														{$$ = new nodo("DECLARACION", [$1,$2,$3])}
...
FUNCION 
		:TIPO FUNC PARAMETROS parDer llaIzq INSTRUCCIONES llaDer  		{$$ = new nodo("FUNCION", [$1[0],$1[1],$3,$3,$5,$6,$7])}
		|TIPO FUNC parDer llaIzq INSTRUCCIONES llaDer             		{$$ = new nodo("FUNCION", [$1[0],$1[1],$3,$3,$5,$6])}
		|TIPO FUNC PARAMETROS parDer llaIzq llaDer             			{$$ = new nodo("FUNCION", [$1[0],$1[1],$3,$3,$5,$6])}
		|TIPO FUNC parDer llaIzq llaDer							    	{$$ = new nodo("FUNCION", [$1[0],$1[1],$3,$3,$5])}

		|void FUNC PARAMETROS parDer llaIzq INSTRUCCIONES llaDer  		{$$ = new nodo("FUNCION", [$1[0],$1[1],$3,$3,$5,$6,$7])}
		|void FUNC parDer llaIzq INSTRUCCIONES llaDer             		{$$ = new nodo("FUNCION", [$1[0],$1[1],$3,$3,$5,$6])}
		|void FUNC PARAMETROS parDer llaIzq llaDer             			{$$ = new nodo("FUNCION", [$1[0],$1[1],$3,$3,$5,$6])}
		|void FUNC parDer llaIzq llaDer							    	{$$ = new nodo("FUNCION", [$1[0],$1[1],$3,$3,$5])}
