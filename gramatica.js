...
var o=function(k,v,o,l){for(o=o||{},l=k.length;l--;o[k[l]]=v);return o},$V0=[1,6],$V1=[1,13],$V2=[1,14],$V3=[1,15],$V4=[1,16],$V5=[1,17],$V6=[1,18],$V7=[1,8],$V8=[1,25],$V9=[5,15,23,24,25,26,27,44,46],$Va=[1,26],$Vb=[1,27],$Vc=[5,13,15,18,23,24,25,26,27,29,33,34,35,36,42,44,46,58,59,62,63,66,67,70,72,73,74,88,105,106,107,115,116],$Vd=[13,15,48],$Ve=[1,49],$Vf=[1,47],$Vg=[1,41],$Vh=[1,53],$Vi=[1,54],$Vj=[1,55],$Vk=[1,56],$Vl=[1,43],$Vm=[1,50],$Vn=[1,51],$Vo=[1,52],$Vp=[5,13,15,18,23,24,25,26,27,29,31,33,34,35,36,42,44,46,58,59,62,63,66,67,70,72,73,74,88,105,106,107,115,116],$Vq=[1,70],$Vr=[1,71],$Vs=[1,72],$Vt=[1,73],$Vu=[1,74],$Vv=[1,75],$Vw=[1,78],$Vx=[5,13,14,15,18,19,23,24,25,26,27,29,31,33,34,35,36,42,44,46,58,59,62,63,66,67,70,71,72,73,74,78,79,80,81,88,99,100,101,102,103,104,105,106,107,110,111,112,113,114,115,116],$Vy=[2,147],$Vz=[1,82],$VA=[1,85],$VB=[1,83],$VC=[1,84],$VD=[18,29],$VE=[1,89],$VF=[1,98],$VG=[19,31],$VH=[13,15,18,29,33,34,35,36,88,105,106,107],$VI=[2,121],$VJ=[1,107],$VK=[1,113],$VL=[1,114],$VM=[1,115],$VN=[1,116],$VO=[1,117],$VP=[1,118],$VQ=[1,119],$VR=[14,31],$VS=[1,125],$VT=[31,42],$VU=[1,147],$VV=[1,155],$VW=[1,144],$VX=[1,145],$VY=[1,148],$VZ=[1,153],$V_=[1,152],$V$=[1,154],$V01=[1,149],$V11=[1,150],$V21=[1,151],$V31=[5,13,14,15,18,19,23,24,25,26,27,29,31,33,34,35,36,42,44,46,58,59,62,63,66,67,70,71,72,73,74,78,79,80,81,88,105,106,107,110,111,112,113,114,115,116],$V41=[2,123],$V51=[13,15,18,23,24,25,26,27,29,33,34,35,36,42,44,46,58,59,63,67,70,72,73,74,88,105,106,107,115,116],$V61=[13,15,18,23,24,25,26,27,29,33,34,35,36,42,44,46,58,59,62,63,66,67,70,72,73,74,88,105,106,107,115,116],$V71=[2,68],$V81=[1,195],$V91=[1,201],$Va1=[14,19,31],$Vb1=[1,232],$Vc1=[1,230],$Vd1=[1,231],$Ve1=[1,235],$Vf1=[1,236],$Vg1=[1,238],$Vh1=[1,237],$Vi1=[1,233],$Vj1=[1,234],$Vk1=[19,112,113,114],$Vl1=[13,15,18,29,33,34,35,36,88,105,106,107,112],$Vm1=[1,291],$Vn1=[1,307],$Vo1=[13,15,18,23,24,25,26,27,29,33,34,35,36,42,44,46,58,59,62,63,67,70,72,73,74,88,105,106,107,115,116],$Vp1=[42,70];
...
break;
case 102:
this.$ = new relacional(new Literal($$[$0-2], this._$.first_line,this._$.first_column, Valor.id),operador.menor, $$[$0], this._$.first_line,this._$.first_column)
break;
case 103:
this.$ = new relacional(new Literal($$[$0-2], this._$.first_line,this._$.first_column, Valor.id),operador.mayor, $$[$0], this._$.first_line,this._$.first_column)
break;
case 104:
this.$ = new relacional(new Literal($$[$0-2], this._$.first_line,this._$.first_column, Valor.id),operador.menorIgual, $$[$0], this._$.first_line,this._$.first_column)
break;
case 105:
this.$ = new relacional(new Literal($$[$0-2], this._$.first_line,this._$.first_column, Valor.id),operador.mayorIgual, $$[$0], this._$.first_line,this._$.first_column)
break;
case 106:
this.$ = new relacional(new Literal($$[$0-2], this._$.first_line,this._$.first_column, Valor.id),operador.equal, $$[$0], this._$.first_line,this._$.first_column)
break;
case 107:
