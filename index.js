...
function parsear(){
    ...
    void main(){
        ...
        println(pruebasNativas.subString(0,12).toUppercase(), pruebasNativas.caracterOfPosition(12))
        println( pruebasNativas.subString(14,pruebasNativas.length()).toLowercase())
